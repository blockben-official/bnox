...
async function setBsoPoolAddress() {
  console.log(`Start setting up generalFee address...`);
  ...
  console.log(`Setup generalFeeAddress to ${process.env.GENERAL_FEE_ADDRESS!}`);
  const methodCall = contract.methods.setFeeAddress(process.env.GENERAL_FEE_ADDRESS!);
