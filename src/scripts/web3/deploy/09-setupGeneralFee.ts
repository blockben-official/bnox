...
async function setGeneralFee() {
  console.log(`Start setting up generalFee...`);
  ...
  console.log(`Setup generalFee to ${process.env.GENERAL_FEE!}`);
  const methodCall = contract.methods.setGeneralFee(process.env.GENERAL_FEE!);
