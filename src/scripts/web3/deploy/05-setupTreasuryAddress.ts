...
async function setTreasuryAddress() {
  console.log(`Start setting up treasury address...`);
  ...
  console.log(`Setup treasuryAddress to ${process.env.TREASURY_ADDRESS!}`);
  const methodCall = contract.methods.setTreasuryAddress(process.env.TREASURY_ADDRESS!);
