...
import artifact from '../../../artifacts/contracts/BlockNoteX.sol/BlockNoteX.json';
...
async function deployViaWeb3() {
  ...
  const contract = new web3.eth.Contract(abiFunctions as AbiItem[]) as unknown as BlockNoteX;
  ...
  // Check if gasPrice is more than 55 GWEI
  while (gasPrice.gte(web3.utils.toBN('55000000000'))) {
