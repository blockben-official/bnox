...
async function setBsoPoolAddress() {
  console.log(`Start setting up bsoPool address...`);
  ...
  console.log(`Setup bsoPoolAddress to ${process.env.BSOPOOL_FEE_ADDRESS!}`);
  const methodCall = contract.methods.setBsoPoolAddress(process.env.BSOPOOL_FEE_ADDRESS!);
