...
async function setURL() {
  console.log(`Start setting up url...`);
  ...
  console.log(`Setup url to ${process.env.TOKEN_INFORMATION_URL!}`);
  const methodCall = contract.methods.setUrl(process.env.TOKEN_INFORMATION_URL!);
