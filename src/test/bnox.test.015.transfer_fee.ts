...
describe('BNOX - 015: transfer fee', () => {
  let BNOX: BlockNoteX;
  ...
  it('fee calculation: 100 - 0.001% - 0.001%', async () => {
    await BNOX.connect(treasuryAdmin).mint(user.address, 50000000);
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 100);
  ...
  it('fee calculation: 10000 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 10000);
  ...
  it('fee calculation: 24900 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 24900);
  ...
  it('fee calculation: 25000 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 25000);
  ...
  it('fee calculation: 49900 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 49900);
  ...
  it('fee calculation: 50000 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 50000);
  ...
  it('fee calculation: 74900 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 74900);
  ...
  it('fee calculation: 75000 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 75000);
  ...
  it('fee calculation: 124900 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 124900);
  ...
  it('fee calculation: 125000 - 0.001% - 0.001%', async () => {
    ...
    await BNOX.setBsoFee(1);
    await BNOX.setGeneralFee(1);
    await BNOX.connect(user).transfer(anotherUser.address, 125000);
  ...
  it('fee calculation: 400 - 0.060% - 0.040%', async () => {
    ...
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 400);
  ...
  it('fee calculation: 500 - 0.060% - 0.040%', async () => {
    ...
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 500);
  ...
  it('fee calculation: 800 - 0.060% - 0.040%', async () => {
    ...
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 800);
  ...
  it('fee calculation: 900 - 0.060% - 0.040%', async () => {
    ...
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 900);
  ...
  it('fee calculation: 1400 - 0.060% - 0.040%', async () => {
    ...
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 1400);
  ...
  it('fee calculation: 1500 - 0.060% - 0.040%', async () => {
    ...
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 1500);
  ...
  it('fee calculation: 1000000 - 0.060% - 0.040%', async () => {
    ...
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 1000000);
  ...
  it('fee calculation: 2500000000 - 0.060% - 0.040%', async () => {
    await BNOX.connect(treasuryAdmin).mint(user.address, 5000000000);
    await BNOX.setBsoFee(60);
    await BNOX.setGeneralFee(40);
    await BNOX.connect(user).transfer(anotherUser.address, 2500000000);
  ...
  it('fee calculation: 100 - 0.100% - 0.066%', async () => {
    await BNOX.connect(treasuryAdmin).mint(user.address, 50000000);
    await BNOX.setBsoFee(100);
    await BNOX.setGeneralFee(66);
    await BNOX.connect(user).transfer(anotherUser.address, 100);
  ...
  it('fee calculation: 300 - 0.100% - 0.066%', async () => {
    ...
    await BNOX.setBsoFee(100);
    await BNOX.setGeneralFee(66);
    await BNOX.connect(user).transfer(anotherUser.address, 300);
  ...
  it('fee calculation: 1000 - 0.100% - 0.066%', async () => {
    ...
    await BNOX.setBsoFee(100);
    await BNOX.setGeneralFee(66);
    await BNOX.connect(user).transfer(anotherUser.address, 1000);
  ...
  it('fee calculation: 1600 - 0.100% - 0.066%', async () => {
    ...
    await BNOX.setBsoFee(100);
    await BNOX.setGeneralFee(66);
    await BNOX.connect(user).transfer(anotherUser.address, 1600);
  ...
  it('fee calculation: 2100 - 0.100% - 0.066%', async () => {
    ...
    await BNOX.setBsoFee(100);
    await BNOX.setGeneralFee(66);
    await BNOX.connect(user).transfer(anotherUser.address, 2100);
  ...
  it('fee calculation: 2200 - 0.100% - 0.066%', async () => {
    ...
    await BNOX.setBsoFee(100);
    await BNOX.setGeneralFee(66);
    await BNOX.connect(user).transfer(anotherUser.address, 2200);
