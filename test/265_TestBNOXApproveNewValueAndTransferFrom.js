...
contract('BNOXToken', function(accounts) {
    it("265. test of BNOXToken: Approve - Paused", function() {
        return BNOXTokenContract.deployed().then(function(instance) {
            ...
            return BNOXTokenContractInstance.mint(accounts[0], 600000, {from: accounts[0]} );
        }).then(function(result) {
            ...
            assert.equal(fromBalance, 100000, "BNOX token allocation after transfer - from balance");            
