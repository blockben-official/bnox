...
contract('BNOXToken', function(accounts) {
	it("240. test of BNOXToken: Fee calculation 100 - 0.040% - 0.060%", function() {
		return BNOXTokenContract.deployed().then(function(instance) {
			...
			assert.equal(fromBalance, 49999900, "BNOX token allocation after transfer - from balance");
			assert.equal(toBalance, 100, "BNOX token allocation after transfer - to balance");
