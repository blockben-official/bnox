...
contract('BNOXToken', function(accounts) {
	it("261. test of BNOXToken: Fee calculation 1000000 - 0.066% - 0.100%", function() {
		return BNOXTokenContract.deployed().then(function(instance) {
			...
			assert.equal(bsoBalance, 1000, "BNOX token allocation after transfer - BSO Fee balance");
			assert.equal(feeBalance, 660, "BNOX token allocation after transfer - Processing Fee balance");
